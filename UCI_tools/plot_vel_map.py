...
# Load gas data
data = h5py.File('/DFS-L/DATA/cosmo/grenache/omyrtaj/analysis_data/metaldiff/m12_elvis_ThelmaLouise_res4000/id_jnet_jzjc_jjc_'+snap[0]+'_host0_20kpc_rockstar_centers_metaldiff.hdf5','r')
